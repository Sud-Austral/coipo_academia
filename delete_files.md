...
El detector encontro **1** candidatos (12 KB), el **0.2%** de los 473 archivos que el analizador recorre en cada corrida.
...
| --- | ---: | --- |
| `db/setup_bd_v2.sql` | 12 KB | El revisor no se pronuncio sobre este archivo. El detector lo marco como variante o respaldo. |
